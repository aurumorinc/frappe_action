...
import json
from frappe_orbit.orbit.doctype.action_node_cache.action_node_cache import get, save, infer_action

class TestActionCacheAPI(IntegrationTestCase):
	@patch("frappe_orbit.orbit.doctype.action_node_cache.action_node_cache.frappe.db.exists")
	@patch("frappe_orbit.orbit.doctype.action_node_cache.action_node_cache.frappe.get_doc")
	@patch("frappe_orbit.orbit.doctype.action_node_cache.action_node_cache.frappe.get_all")
	@patch("frappe_orbit.orbit.doctype.action_node_cache.action_node_cache.frappe.db.commit")
	...
	@patch("frappe_orbit.orbit.doctype.action_node_cache.action_node_cache.frappe.get_doc")
	@patch("frappe_orbit.orbit.doctype.action_node_cache.action_node_cache.litellm.completion")
